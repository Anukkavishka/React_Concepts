/* Important thing to notice is that you should not mutate the DOM with jquery or something like that, 
since React is tracking everything using using a virtual DOM those changes won't be recognized 
by Virtual Dom which leaves our apps in a unpredictable state
https://reactjs.org/docs/react-component.html more information
 */
...
class ContrivedComponent extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState, nextContext) {
    ...
    return nextProps.shouldUpdate //since i'm returnig this to control the child component being updated after a change even though there is a state change in the app
  }
  /**
  ...
  render() {
    ...
    return (
      <div style={{padding: 20, border: 'solid 4px #ddd'}}>
        Hi! I'm the child component. Here are my props:
    ...
    return (
      <div>
        <div style={{fontSize: '2em', fontWeight: 'bold'}}>
          Hi! I'm a deliberately created component
        </div>
